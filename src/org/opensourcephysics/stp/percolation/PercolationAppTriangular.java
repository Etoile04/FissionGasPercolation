...
import org.eclipse.swt.graphics.Drawable;//Environment dependent
import org.eclipse.swt.graphics.GCData;//Environment dependent
 ...
 */
public class PercolationAppTriangular extends AbstractCalculation implements InteractiveMouseHandler, Drawable, org.opensourcephysics.display.Drawable {
  int[][] rsite; // size of array = L + 1, lattice
  static final int OCCUPIED = 1, EMPTY = 0;
  double p;      // chance of being occupied
  int Rs;   //seed of random generator
   ...
   */
  public PercolationAppTriangular() {
    random = new Random();
  ...
  public void calculate() {
	Rs = control.getInt("Rs");//getInt only accept 1 letter
	random.setSeed(Rs);//random.setSeed(1249012312);
    L = control.getInt("L");
  ...
  public static void main(String[] args) {
    CalculationControl.createApp(new PercolationAppTriangular(), args);
  }
