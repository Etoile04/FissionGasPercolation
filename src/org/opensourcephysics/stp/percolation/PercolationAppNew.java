...
/**
 * PercolationAppNew displays site percolation clusters.
 *
 ...
 */
public class PercolationAppNew extends AbstractCalculation implements InteractiveMouseHandler {
  LatticeFrame lattice = new LatticeFrame("R","Z","Pellet Fission Gas Percolation");//("Percolation");
  Random random = new Random();
  int L;
  int clusterNumber; // used to color clusters

  /**
   * Creates the PercolationAppNew and sets the colors for lattice.
   */
  public PercolationAppNew() {
  ...
  */
  ...
  public static void main(String args[]) {
    CalculationControl.createApp(new PercolationAppNew());
  }
}
